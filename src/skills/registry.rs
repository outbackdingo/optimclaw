...
//! 2. User skills directory (`~/.optimclaw/skills/`) -- Trusted
//!
...
pub struct SkillRegistry {
    ...
    /// User skills directory (~/.optimclaw/skills/). Skills here are Trusted.
    user_dir: PathBuf,
    /// Registry-installed skills directory (~/.optimclaw/installed_skills/). Skills here are Installed.
