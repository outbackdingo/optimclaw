...
use optimclaw::channels::Channel;
use optimclaw::channels::wasm::{
...
use optimclaw::pairing::PairingStore;
...
mod loader_tests {
    ...
    async fn test_discover_channels_empty_dir() {
        ...
        let channels = optimclaw::channels::wasm::discover_channels(dir.path())
            .await
...
mod message_emission_tests {
    use super::*;
    use optimclaw::channels::wasm::{ChannelHostState, EmittedMessage};
